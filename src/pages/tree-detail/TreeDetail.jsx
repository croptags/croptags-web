...
const fetchTreeData = async (treeId) => {
  ...
  // When Api Ready
  // const res = await fetch(`https://api.yourdomain.com/trees/${treeId}`);
...
export const TreeDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-[#F4F6F7] to-[#ECFFF7]">
      ...
      <div className="space-y-4 px-4 py-4">
        <TreeInfoCard>
          ...
          <p className="text-[#788D98] text-sm mt-1 mb-2">{tree.tree_label}</p>
